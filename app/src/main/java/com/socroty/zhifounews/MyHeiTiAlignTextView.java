...
public class MyHeiTiAlignTextView extends TextView {

    private List<String> lines = new ArrayList<>(); // 分割后的行
    private List<Integer> tailLines = new ArrayList<>(); // 尾行
    private String oldText;

    public MyHeiTiAlignTextView(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public MyHeiTiAlignTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
