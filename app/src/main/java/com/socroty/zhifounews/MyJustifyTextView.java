...
public class MyJustifyTextView extends TextView {
    private int mLineY;
    private int mViewWidth;

    public MyJustifyTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);
    }

    private void applyCustomFont(Context context) {
        Typeface customFont = Typeface.createFromAsset(context.getAssets(), "fonts/MyEnglishFont.TTF");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textHeight = (int) (textHeight * layout.getSpacingMultiplier() + layout.getSpacingAdd()); //解决了最后一行文字间距过大的问题
