...
public class MySongTiAlignTextView extends TextView{

    private List<String> lines = new ArrayList<>(); // 分割后的行
    private List<Integer> tailLines = new ArrayList<>(); // 尾行
    private String oldText;

    public MySongTiAlignTextView(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public MySongTiAlignTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
